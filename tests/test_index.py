...
def test_mapping_4km():
    ...
    grid_index = geogridstore.index.coords_to_unique_index(coords=search_coords, reference_grid_coordinates=REF_COORDS_4km)
...
def test_mapping_duplicate_reference_index():
    ...
    with pytest.raises(ValueError, match="Duplicate reference gid created"):
        geogridstore.index.coords_to_unique_index(coords=problem_coords, grid_points_fn="4km-points.npz")
